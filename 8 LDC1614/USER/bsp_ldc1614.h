#ifndef __BSP_LDC1614__
#define	__BSP_LDC1614__
...
#define LDC13xx16xx_CMD_STATUS            	0x18		//状态寄存器
#define LDC13xx16xx_CMD_ERROR_CONFIG       	0x19     	//状态控制寄存器
#define LDC13xx16xx_CMD_CONFIG             	0x1A     	//配置
...
void LDC1614_GetData(uint16_t allData[4]);
